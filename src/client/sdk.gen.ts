 ...
 */
export const contestControllerGetCurrentContest = <ThrowOnError extends boolean = false>(options?: Options<ContestControllerGetCurrentContestData, ThrowOnError>) => (options?.client ?? client).get<ContestControllerGetCurrentContestResponses, unknown, ThrowOnError>({ url: '/contest', ...options });
